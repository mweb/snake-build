...
IMPORTANT: The keys are all transfered to lower case since the ini format does
...
The Config object is implemented as a singleton and thefore can be used from
...
On Windows this order is slightly differnt:
