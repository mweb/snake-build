...
from snakebuild.commands import register_argument_parser
...
def parse_command_line(args, version):
    ...
    '''
    parser = ArgumentParser(description=_('The buildserver server to manage '
            'all the build agents.'), version=version)
    ...
    register_argument_parser(parser)
